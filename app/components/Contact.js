            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-600">9005003044</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-600 break-words">bodymindbalancepalavacity@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-600">
                    Elite E- 006, Lakeshore green, Lodha Palava Phase 2<br />
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="text-base text-gray-600 space-y-1">
                    ...
                    <p>Morning: 10:30 AM - 11:00 AM</p>
                    <p>Evening: 5:45 PM - 10:00 PM</p>
                    <p>Thursday: Closed</p>
                  </div>
                </div>
              </div>
